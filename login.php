...
if ($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $sql = "Select * from nanny where username='$uname' AND password='$pass' ";
...
<!-- PHP ENDS -->
    ...
    <Body style="background-position: center; background-repeat: no-repeat; background-size: cover;"
        background="./images/nanny4.jpg"></Body>
    ...
    <div class="container my-4">
        ...
        <form action="./login.php" method="post">
            <div class="form-group">
                ...
                <!-- Login Button -->
                <button style="width: 50%;" class="btn btn-primary" id="b1" name="login">Login</button>
            ...
            <!-- Register Button -->
            <a href="./register.php"><button style="width: 50%;" class="btn btn-primary" id="b2">Register</button></a>
