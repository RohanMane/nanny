...
if($pass == $cpassword && $name != "" && $locality != "" && $contact1 != "" && $contact2 != "" && $srequired != "" && $uname != "" && $pass != "" && $cpassword != ""){
    $sql = "INSERT INTO `nanny` (`name`, `locality`, `contact1`, `contact2`, `username`, `password`, `cpassword`,`skillsrequired`) VALUES ('$name', '$locality', '$contact1', '$contact2', '$uname', '$pass', '$cpassword', '$srequired')";
