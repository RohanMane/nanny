...
<head>
    ...
    <title>PROFILE EDIT FORM HERE</title>
...
if($pass == $cpassword && $profile != "" && $name != "" && $locality != "" && $contact1 != "" && $contact2 != "" && $experience != "" && $skills != ""  && $uname != "" && $pass != "" && $cpassword != ""){
    $sql = "UPDATE `enanny` SET `profile` = '$profile', `name` = '$name', `locality` = '$locality', `contact1` = '$contact1', `contact2` = '$contact2', `skills` = '$skills', `password` = '$pass', `cpassword` = '$cpassword', `experience` = '$experience' WHERE `enanny`.`username` = '$uname'; ";
